...
Module ModMasterClient
    ...
    Friend Function GetClientIndividuUpdate() As DataTable
        ...
        objClient.UserAccess = objAccess
        dtClientIndividu = objClient.Search(objMasterSimpi, "")
    ...
    Friend Function GetClientInstitusiUpdate() As DataTable
        ...
        objClient.UserAccess = objAccess
        dtClientInstitusi = objClient.Search(objMasterSimpi, "")
    ...
    Friend Function GetClientIndividuSubUpdate() As DataTable
        ...
        objClient.UserAccess = objAccess
        dtClientIndividuSub = objClient.Search(objMasterSimpi, "")
        dtClientIndividuSub.CaseSensitive = False
        Return dtClientIndividuSub
    End Function
    ...
    Friend Function GetClientInstitusiSubUpdate() As DataTable
        ...
        objClient.UserAccess = objAccess
        dtClientInstitusiSub = objClient.Search(objMasterSimpi, "")
        dtClientInstitusiSub.CaseSensitive = False
        Return dtClientInstitusiSub
    End Function
    ...
    Friend Function GetClientDistributorUpdate() As DataTable
        ...
        objClient.UserAccess = objAccess
        dtClientDistributor = objClient.Search(objMasterSimpi, "")
