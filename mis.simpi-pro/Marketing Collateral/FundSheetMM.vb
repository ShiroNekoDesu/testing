...
Public Class FundSheetMM
    ...
    Private Sub FundSheetMM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dtMM.Columns.Add("Asset", GetType(String))
        dtMM.Columns.Add("Value", GetType(Decimal))
        dtMM.Columns.Add("TTM", GetType(Integer))
        dtMM.Columns.Add("Duration", GetType(Decimal))
        dtMM.Columns.Add("YTM", GetType(Decimal))
    End Sub
...
#Region "holding"
    ...
    Private Sub chkAlpha_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkAlpha.CheckedChanged
        ...
        Dim cdsc As ChartDataSeriesCollection = chartAsset.ChartGroups(0).ChartData.SeriesList
    ...
    Private Sub chkAntiAlias_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkAntiAlias.CheckedChanged
        chartAsset.UseAntiAliasedGraphics = chkAntiAlias.Checked
    End Sub
    ...
    Private Sub pieCheck()
        ...
        Else
            ...
            chartAsset.ChartGroups.Group0.Pie.InnerRadius = 0
        End If
    End Sub
    ...
    Private Sub DisplaySecuritiesAsset()
        If dtHolding IsNot Nothing AndAlso dtHolding.Rows.Count > 0 Then
            ...
            chartAsset.ChartLabels.DefaultLabelStyle.Border.BorderStyle = C1.Win.C1Chart.BorderStyleEnum.Solid
