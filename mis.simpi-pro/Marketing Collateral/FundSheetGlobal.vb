...
#Region "holding"
            ...
            If Top > 0 Then
                ...
                If rbName.Checked Then
                    Dim query2 = From q In query1 Order By q.SecuritiesName Ascending
                                 Select No = _no(), Share = q.SecuritiesCode, Name = q.SecuritiesName, TypeCode = q.TypeCode, Country = q.Country,
    ...
    Private Sub DisplayHoldingList(ByVal dataHolding As Object)
        With DBGHolding
            ...
            .Splits(0).DisplayColumns("Country").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
