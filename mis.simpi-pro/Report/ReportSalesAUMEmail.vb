...
Public Class ReportSalesAUMEmail
    Public frm As ReportSalesAUM
    ...
    Private Sub GenerateAttachment()
        ...
        If rbFund.Checked Then
            lblAttachment.Text = frm.ExportExcelFund(True)
        ElseIf rbClient.Checked Then
            lblAttachment.Text = frm.ExportExcelClient(True)
        ElseIf rbsales.Checked Then
            lblAttachment.Text = frm.ExportExcelSales(True)
        Else
            lblAttachment.Text = frm.ExportExcelDetail(True)
        End If
    ...
    Private Sub EmailSend()
        Try
            ...
            Cursor = Cursors.WaitCursor
            emailGateway.Send2(lblFromEmail.Text, lblFromName.Text, txtTo.Text, txtSubject.Text,
                               msg, cc, txtBCC.Text, lblAttachment.Text)
            Cursor = Cursors.Default
            Close()
