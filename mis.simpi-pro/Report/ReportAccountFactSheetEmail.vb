...
Public Class ReportAccountFactSheetEmail
    ...
    Private Sub GenerateAttachment()
        ...
        If rbTransaction.Checked Then
            lblAttachment.Text = frm.ExportExcelTransaction(True)
        ElseIf IsHolding Then
            lblAttachment.Text = frm.ExportExcelHolding(True)
        Else
            lblAttachment.Text = frm.ExportPDF(True)
        End If
