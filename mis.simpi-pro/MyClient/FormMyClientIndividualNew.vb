...
Public Class FormMyClientIndividualNew
    ...
    Private Sub FormMyClientIndividualNew_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "save"
    ...
    Private Sub chkSpouseBirth_CheckedChanged(sender As Object, e As EventArgs) Handles chkSpouseBirth.CheckedChanged
        If chkSpouseBirth.Checked Then
            chkSpouseBirth.Text = "Y"
        Else
            chkSpouseBirth.Text = "N"
        End If
    End Sub

    Private Sub chkIDCardIsExpired_CheckedChanged(sender As Object, e As EventArgs) Handles chkIDCardIsExpired.CheckedChanged
        If chkIDCardIsExpired.Checked Then
            chkIDCardIsExpired.Text = "Y"
        Else
            chkIDCardIsExpired.Text = "N"
        End If
    End Sub
