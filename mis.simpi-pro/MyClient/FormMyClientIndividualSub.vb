...
Public Class FormMyClientIndividualSub
    ...
    Public Sub ClientLoad()
        ...
        Else
            ...
            'sub
            lblCodeSub.Text = objClient.GetClientCode
            lblNameSub.Text = objClient.GetClientName
            lblStatusSub.Text = objClient.GetClientStatus.GetStatusCode
    ...
    Private Sub ClientEdit()
        Dim frm As New FormMyClientIndividualSubEdit
        frm.Show()
